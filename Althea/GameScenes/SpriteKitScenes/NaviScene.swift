...
class NaviScene: SKScene, SKPhysicsContactDelegate {
    ...
    func setupPlayerNode() {
        //        player = childNode(withName: "down_stop_nav") as! SKSpriteNode
        //        player.name = "Player"
        ...
        characterNavigator.name = "Player"
        ...
        characterNavigator.physicsBody?.categoryBitMask = PhysicsCategory.Player
        characterNavigator.physicsBody?.contactTestBitMask = PhysicsCategory.CornerArea | PhysicsCategory.MiddleArea | PhysicsCategory.Apple | PhysicsCategory.Wheat | PhysicsCategory.Rock | PhysicsCategory.Pineapple | PhysicsCategory.Wood | PhysicsCategory.Bomb
        characterNavigator.physicsBody?.collisionBitMask = PhysicsCategory.CornerArea | PhysicsCategory.MiddleArea | PhysicsCategory.Playerss
        ...
        characterCook.physicsBody?.collisionBitMask = PhysicsCategory.CornerArea | PhysicsCategory.MiddleArea | PhysicsCategory.Player
    }
    ...
    private func updateCharacter() {
        ...
        case .rightRun:
            characterNavigator.texture = SKTexture(imageNamed: "right_stop_nav")
            characterNavigator.texture = SKTexture(imageNamed: "navi1")
            characterNavigator.texture = SKTexture(imageNamed: "navi2")
            characterNavigator.texture = SKTexture(imageNamed: "navi3")
        ...
        case .leftRun:
            characterNavigator.texture = SKTexture(imageNamed: "left_stop_nav")
            characterNavigator.texture = SKTexture(imageNamed: "navi1left")
            characterNavigator.texture = SKTexture(imageNamed: "navi2left")
            characterNavigator.texture = SKTexture(imageNamed: "navi3left")
    ...
    private func moveCharacter(direction: Direction) {
        ...
        case .up:
            yOffset = 5
            game.sendNavigatorData(xPosition: 0, yPosition: 5)
            
        case .right:
            xOffset = 5
            game.sendNavigatorData(xPosition: 5, yPosition: 0)
    ...
    override func update(_ currentTime: TimeInterval) {
        let offsetX = characterNavigator.position.x - size.width / 2
        let offsetY = characterNavigator.position.y - size.height / 2
