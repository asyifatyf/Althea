...
class SupplyScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        characterImage = childNode(withName: "down_stop_sup") as! SKSpriteNode
        characterImage1 = childNode(withName: "down_stop") as! SKSpriteNode
        characterImage2 = childNode(withName: "down_stop_nav") as! SKSpriteNode
    ...
    private func updateCharacter() {
        ...
        case .upStop:
            characterImage.texture = SKTexture(imageNamed: "up_stop_sup")
        case .upRun:
            characterImage.texture = SKTexture(imageNamed: "up_stop_sup")
            
        case .rightStop:
            characterImage.texture = SKTexture(imageNamed: "right_stop_sup")
        case .rightRun:
            characterImage.texture = SKTexture(imageNamed: "right_stop_sup")
            
        case .downStop:
            characterImage.texture = SKTexture(imageNamed: "down_stop_sup")
        case .downRun:
            characterImage.texture = SKTexture(imageNamed: "down_stop_sup")
            
        case .leftStop:
            characterImage.texture = SKTexture(imageNamed: "left_stop_sup")
        case .leftRun:
            characterImage.texture = SKTexture(imageNamed: "left_stop_sup")
