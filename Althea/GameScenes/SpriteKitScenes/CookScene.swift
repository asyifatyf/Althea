...
class CookScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        characterImage = childNode(withName: "down_stop") as! SKSpriteNode
        characterImage1 = childNode(withName: "down_stop_nav") as! SKSpriteNode
        characterImage2 = childNode(withName: "down_stop_sup") as! SKSpriteNode
    ...
    private func updateCharacter() {
        ...
        case .upStop:
            characterImage.texture = SKTexture(imageNamed: "up_stop")
        case .upRun:
            characterImage.texture = SKTexture(imageNamed: "up_run")
            
        case .rightStop:
            characterImage.texture = SKTexture(imageNamed: "right_stop")
        case .rightRun:
            characterImage.texture = SKTexture(imageNamed: "right_run")
            
        case .downStop:
            characterImage.texture = SKTexture(imageNamed: "down_stop")
        case .downRun:
            characterImage.texture = SKTexture(imageNamed: "down_run")
            
        case .leftStop:
            characterImage.texture = SKTexture(imageNamed: "left_stop")
        case .leftRun:
            characterImage.texture = SKTexture(imageNamed: "left_run")
